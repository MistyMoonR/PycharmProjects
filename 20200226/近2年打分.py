...
for row in range(2, ws.max_row + 1):
	...
	#算合计分数
	ws.cell(row, 25).value = ws.cell(row, 18).value + ws.cell(row, 19).value +ws.cell(row, 20).value + ws.cell(row, 21).value + ws.cell(row, 22).value + ws.cell(row, 23).value
